...
[Anka Virtualization](https://veertu.com/technology/) and the [Anka Build Cloud](https://veertu.com/anka-build/). The builder takes the path to macOS installer .app 
